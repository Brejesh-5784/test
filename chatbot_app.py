...
def display_meal_plan(meal_data):
    ...
    st.write("📊 **[VERBOSE]** Rendering meal plan...")
    ...
    st.write("✅ **[VERBOSE]** Meal plan rendered successfully!")

def display_workout_plan(workout_data):
    """Display detailed workout plan."""
    st.write("📊 **[VERBOSE]** Rendering workout plan...")
    ...
    st.write("✅ **[VERBOSE]** Workout plan rendered successfully!")
    ...
    if st.button("🍽️ Generate Meal Plan", use_container_width=True):
        if not st.session_state.user_profile:
            ...
            with st.spinner("Creating your personalized meal plan..."):
                ...
                st.write(f"✅ **[VERBOSE]** Profile loaded: {profile['gender']}, {profile['age']}y, Goal: {profile['goal']}")
                st.write(f"🎯 **[VERBOSE]** Target: {profile['targets']['daily_calories']} kcal, {profile['targets']['daily_protein_g']}g protein")
                st.write("🤖 **[VERBOSE]** Calling Gemini AI for meal plan...")
                ...
                if meal_data:
                    st.write("✅ **[VERBOSE]** Meal plan generated successfully!")
                    st.write(f"📊 **[VERBOSE]** Generated {len(meal_data.get('meals', []))} meal times")
    ...
    if st.button("🏋️ Generate Workout Plan", use_container_width=True):
        if not st.session_state.user_profile:
            ...
            with st.spinner("Creating your personalized workout plan..."):
                st.write("🔍 **[VERBOSE]** Starting workout plan generation...")
                profile = st.session_state.user_profile
                st.write(f"✅ **[VERBOSE]** Profile loaded: {profile['gender']}, {profile['age']}y, Level: {profile['fitness_level']}")
                st.write(f"🎯 **[VERBOSE]** Goal: {profile['goal']}")
                st.write("🤖 **[VERBOSE]** Calling Gemini AI for workout plan...")
                ...
                if workout_data:
                    st.write("✅ **[VERBOSE]** Workout plan generated successfully!")
                    st.write(f"📊 **[VERBOSE]** Generated {len(workout_data.get('weekly_plan', []))} days of workouts")
                    st.session_state.messages.append({
                        "role": "assistant",
                    ...
                    st.error(f"❌ **[VERBOSE]** Failed to generate workout plan: {raw}")
